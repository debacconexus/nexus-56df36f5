...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Professional Learning & Development (PLD) System for Special Education in Inclusive Classrooms";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Individual Educator";
process.env.TABLE_NAME = process.env.TABLE_NAME || "individual_educator_records";
'use strict';
